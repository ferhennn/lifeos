import { History, CheckCircle2, Plus, Target, Compass, FolderKanban, ListTodo } from "lucide-react";
import { formatDistanceToNow } from "date-fns";
import type { ActivityItem } from "../actions/dashboard.actions";

const typeIcon = { task: ListTodo, goal: Target, strategy: Compass, project: FolderKanban };
