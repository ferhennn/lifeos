...
import { Target, Compass, FolderKanban, ListTodo, ArrowRight, LayoutDashboard, Share2, Zap } from "lucide-react";
...
const dailyFlow = [
  ...
  { label: "Check the dashboard", desc: "Today's focus task, today's LinkedIn post, and your schedule, all in one glance each morning." },
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-xl">
        ...
        <div className="rounded-lg border border-dashed border-border p-3">
          <p className="mb-2.5 text-xs font-medium uppercase tracking-wide text-muted-foreground/70">A day in LifeOS</p>
        ...
        <ul className="space-y-2.5 text-sm">
          ...
          <li className="flex gap-2.5">
            ...
            <span>
              ...
              <span className="text-muted-foreground">
                Runs independently of the goal chain. Bulk-upload a month of posts up front, then the dashboard surfaces
                today's — mark it posted and move on.
              </span>
            </span>
          </li>
          <li className="flex gap-2.5">
